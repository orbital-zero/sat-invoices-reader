...
class InvoiceFileReaderTest(unittest.TestCase):
    ...
    def test_list_zip_files(self):
        ...
        callback = Callback()
        fx = lambda filename, zip_file: self.__fault_zip_callback(filename, zip_file, callback.result)
    ...
    def test_list_zip_callback_err(self):
        ...
        callback = Callback()
        fx = lambda filename, zip_file: self.__fault_err_callback(filename, zip_file)
        callback.set_function(fx)
